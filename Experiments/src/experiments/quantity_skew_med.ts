...
// EXPERIMENT 2: QUANTITY SKEW
console.log("quantity_skew.ts: loaded");
...
// -----------------------------
// Presets: QUANTITY SKEW
// -----------------------------
type QuantitySkewPreset = Array<{ numSamples: number }>;

const QUANTITY_SKEW_LOW = [
  { numSamples: 100 },
  { numSamples: 100 },
  { numSamples: 100 },
];

const QUANTITY_SKEW_MED = [
  { numSamples: 150 },
  { numSamples: 100 },
  { numSamples: 50 },
];

const QUANTITY_SKEW_HIGH = [
  { numSamples: 240 },
  { numSamples: 50 },
  { numSamples: 10 },
];
...
// Variant builders
// -----------------------------
function quantitySkewVariant(name: string, preset: QuantitySkewPreset): Variant {
  return {
    name,
    clientPatches: [
      { data: { numSamples: preset[0].numSamples } },
      { data: { numSamples: preset[1].numSamples } },
      { data: { numSamples: preset[2].numSamples } },
    ],
  };
}
...
function buildAblations(): Ablation {
  return {
    name: "quantity_skew",
    variants: [
      // quantitySkewVariant("low", QUANTITY_SKEW_LOW),
      quantitySkewVariant("med", QUANTITY_SKEW_MED),
      // quantitySkewVariant("high", QUANTITY_SKEW_HIGH),
    ],
  };
}
...
// -----------------------------
async function main() {
  console.log("quantity_skew.ts: main() starting");
